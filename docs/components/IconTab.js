  ...
  render() {
    return (
      <Tabs customStyle={this.props.customStyle}>
        <TabList>
          <Tab>
            <i className="fa fa-music pr2" />
            High!
          </Tab>
          <Tab>
            <i className="fa fa-angellist pr2" />
            YoYo
          </Tab>
          <Tab>
        ...
        <PanelList>
          <Panel>
            Accusamus enim nisi itaque voluptas nesciunt repudiandae velit.{" "}
            <br />
          ...
          <Panel>
            Officiis commodi facilis optio eum aliquam.
            <br />
          ...
          <Panel>
            Ut voluptas a voluptas quo ut dolorum.
            <br />
            Dolorem sint velit explicabo sunt distinctio dolorem adipisci
            tempore.
            <br />
            Est repellat quis magnam quo nihil amet et. Iste consequatur
            architecto quam neque suscipit.
          </Panel>
        </PanelList>
      </Tabs>
    );
